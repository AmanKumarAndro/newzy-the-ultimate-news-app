...
import os
for dirname, _, filenames in os.walk('D:/Coding/text'):
...
X_train, X_test, y_train, y_test = train_test_split(
    X_vectors, data['label'], test_size=0.2, random_state=42)
...
input_title = "Palestinian officials say Israeli air strikes hit Gaza hospitals - Reuters"
